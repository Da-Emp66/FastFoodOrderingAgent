...
if [ "$1" = "--legacy-python-script" ]; then
    ...
    MODEL_LOCAL_DIR=$CURRENT_SCRIPT_DIR/../$(yq '.MODEL_ARGS.local_dir' $CONFIGURATION_FILE)
    MMPROJ_LOCAL_DIR=$CURRENT_SCRIPT_DIR/../$(yq '.VISION_ARGS.local_dir' $CONFIGURATION_FILE)

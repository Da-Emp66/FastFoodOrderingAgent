...
class DSPyPlanner(BrowserActionPlanner):
    class WebToolOutputEvaluatorSignature(dspy.Signature):
        ...
        previous_browser_screenshot: dspy.Image = dspy.InputField(
            desc="Image of what the browser looked like last time, before the last interaction. The screenshot may show UI elements labeled with numbered boxes (0, 1, 2, etc.). " \
        ...
        current_browser_screenshot: dspy.Image = dspy.InputField(
            desc="Image of what the browser currently looks like based on any previous interactions. The screenshot may show UI elements labeled with numbered boxes (0, 1, 2, etc.). " \
